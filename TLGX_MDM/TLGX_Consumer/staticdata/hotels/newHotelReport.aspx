<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="newHotelReport.aspx.cs" Inherits="TLGX_Consumer.staticdata.hotels.newHotelReport"  MasterPageFile="~/Site.Master" EnableEventValidation="false" %>
...
<asp:Content runat="server" ID="Content1" ContentPlaceHolderID="MainContent">
    ...
    <div class="row">
        <div class="col-md-12">
            <h1 class="page-header">New Hotels Added During Mapping</h1>
        </div>
    </div>
    <div class="container">
        <div class="panel panel-default">
            ...
            <div id="collapseSearch" class="panel-collapse collapse in" aria-expanded="true">
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-sm-4" >
                          <asp:Button runat="server" Text="View Report" ID="btnviewreport"  CssClass="btn btn-primary " OnClick="btnviewreport_Click">
                            </asp:Button>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div style="width: 100%; height: 100%">
             <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="100%" Height="100%" AsyncRendering="False" SizeToReportContent="True" ZoomMode="FullPage" ShowFindControls="False" >
                 <LocalReport ReportPath="hotels\rptNewhotelsReport.rdlc">
                 </LocalReport>
