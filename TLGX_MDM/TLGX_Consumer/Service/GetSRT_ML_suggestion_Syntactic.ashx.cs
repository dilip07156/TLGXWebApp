...
namespace TLGX_Consumer.Service
{
    ...
    public class GetSRT_ML_suggestion_Syntactic : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            {
                var res = Acco.GetRTM_ML_Suggestions_Syntactic(Convert.ToString(Accommodation_SupplierRoomTypeMapping_Id));
