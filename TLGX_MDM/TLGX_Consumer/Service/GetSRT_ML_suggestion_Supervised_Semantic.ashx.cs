...
namespace TLGX_Consumer.Service
{
    ...
    public class GetSRT_ML_suggestion_Supervised_Semantic : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            {
                var res = Acco.GetRTM_ML_Suggestions_Supervised_Semantic(Convert.ToString(Accommodation_SupplierRoomTypeMapping_Id));
