<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ClassificationAttributes.ascx.cs" Inherits="TLGX_Consumer.controls.hotel.ClassificationAttributes" %>
                            ...
                            <asp:Repeater ID="repCASubType" runat="server" DataSource='<%# DataBinder.Eval(Container.DataItem, "SubType") %>'>
                                ...
                                <ItemTemplate>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <asp:GridView ID="grdClassificationAttributes" runat="server" AutoGenerateColumns="false" CssClass="table table-hover table-striped" DataKeyNames="Accommodation_ClassificationAttribute_Id" DataSource='<%# DataBinder.Eval(Container.DataItem, "ListCA") %>' EmptyDataText="There are no classifications set for this product" OnRowCommand="grdClassificationAttributes_RowCommand" OnRowDataBound="grdClassificationAttributes_RowDataBound">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField ShowHeader="false">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="btnSelect" runat="server" CausesValidation="false" CommandArgument='<%# Bind("Accommodation_ClassificationAttribute_Id") %>' CommandName="Select" CssClass="btn btn-default" 
                                        ...
                                        <span aria-hidden="true" class="glyphicon glyphicon-edit"></span>&nbsp; Edit
                                                    ...
                                                    <asp:TemplateField ShowHeader="false">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="btnDelete" runat="server" CausesValidation="false" CommandArgument='<%# Bind("Accommodation_ClassificationAttribute_Id") %>' CommandName='<%# Eval("IsActive").ToString() == "True" ? "SoftDelete" : "UnDelete"   %>' CssClass="btn btn-default">
            ...
            <div class="modal-body centered">
                ...
                <asp:UpdatePanel ID="upClassificationAttributesAddEdit" runat="server">
                    <ContentTemplate>                        
                        ...
                        <asp:FormView ID="frmClassificationAttribute" runat="server" DataKeyNames="Accommodation_ClassificationAttribute_Id" DefaultMode="Insert" OnItemCommand="frmClassificationAttribute_ItemCommand">
