    ...
    function getChartData() {
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result == "") {
                    $("#chartdivs").hide();
                    $("#nodatafound").show().append("<h3>No Data Found.</h3>");
...
<div class="row" id="chartdivs">
    <div class="col5 col-md-6" id="countrydiv" style="text-align: center">
    ...
    <div class="col5 col-md-6 " id="citydiv" style="text-align: center">
        <div class="panel  panel-default">
            <div class="panel-heading" >
                <i class="fa fa-bar-chart-o fa-fw"></i>
    ...
    <div class="col5 col-md-6" id="productdiv"style="text-align: center">
        <div class="panel  panel-default">
            <div class="panel-heading" >
                <i class="fa fa-bar-chart-o fa-fw"></i>
  ...
  <%--  <div class="col5 col-md-6" id="hotelrumdiv"style="text-align: center">
        <div class="panel  panel-default">
            <div class="panel-heading" >
                <i class="fa fa-bar-chart-o fa-fw"></i>
    ...
    <div class="col5 col-md-6" id="activitydiv" style="text-align: center">
        <div class="panel  panel-default">
            <div class="panel-heading" >
                <i class="fa fa-bar-chart-o fa-fw"></i>
