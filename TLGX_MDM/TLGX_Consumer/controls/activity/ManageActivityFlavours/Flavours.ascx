                                                    ...
                                                    <ItemTemplate>
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-xs-2">
                                                                ...
                                                                <asp:DropDownList ID="ddlDurationType" runat="server" CssClass="form-control" AppendDataBoundItems="true">
                                                                    <asp:ListItem Value="0">-Select-</asp:ListItem>
                                                                </asp:DropDownList>
                                                            </div>
                                                            ...
                                                            <div class="panel-footer">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-xs-2">
                                                                        ...
                                                                        <asp:DropDownList ID="ddlDurationType" runat="server" CssClass="form-control">
                                                                        </asp:DropDownList>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-xs-3">
                                                                        ...
                                                                        <div class="input-group input-group-sm">
                                                                            <label class="control-label">
                                                                                ALL
                                                                                    <div>
                                                                                        <input type="checkbox" id="chkAll" name="All" aria-label="Checkbox for daily">
                                                                                    </div>
                                                                            </label>
                                                                            <label class="control-label">
                                                                                M
