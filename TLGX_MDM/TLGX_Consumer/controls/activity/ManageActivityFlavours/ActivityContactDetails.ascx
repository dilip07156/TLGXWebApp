<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ActivityContactDetails.ascx.cs" Inherits="TLGX_Consumer.controls.activity.ManageActivityFlavours.ActivityContactDetails" %>
