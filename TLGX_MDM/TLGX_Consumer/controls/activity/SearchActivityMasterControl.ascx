                            ...
                            <div id="dvGrid" runat="server" class="control-label col-sm-12">
                                <asp:GridView ID="grdSearchResults" runat="server" AllowPaging="false" AllowCustomPaging="false" AutoGenerateColumns="False" DataKeyNames="Activity_Id" CssClass="table table-hover table-striped">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Country" HeaderText="Country" />
                                        <asp:BoundField DataField="City" HeaderText="City" />
                                        <asp:HyperLinkField DataNavigateUrlFields="Activity_Id" DataNavigateUrlFormatString="~/activity/ManageActivityFlavour.aspx?Activity_Id={0}" Text="Select" ControlStyle-Font-Bold="true" NavigateUrl="~/activity/ManageActivityFlavour.aspx" />
                                    </Columns>
                                </asp:GridView>
                            </div>
                        </div>
