<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ShoppingInfo.ascx.cs" Inherits="TLGX_Consumer.controls.activity.ManageActivityMaster.ShoppingInfo" %>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-heading">Shopping Information</div>
            ...
            <div class="form-group">
                <div id="dvGrid" runat="server" class="control-label col-sm-12">
                    <asp:GridView ID="grdSearchResults" runat="server" AllowPaging="false" AllowCustomPaging="false" AutoGenerateColumns="False" DataKeyNames="Activity_Id" CssClass="table table-hover table-striped">
                        <Columns>
                            <asp:BoundField DataField="" HeaderText="Name of the shop" />
                            <asp:BoundField DataField="" HeaderText="Type of Merchandise" />
