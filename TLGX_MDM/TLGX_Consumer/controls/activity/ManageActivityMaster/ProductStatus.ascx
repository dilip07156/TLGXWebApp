...
<asp:UpdatePanel runat="server" ID="updPanStatus">
    <ContentTemplate>
        ...
        <asp:FormView ID="frmActivityStatus" DataKeyNames="Activity_Status_Id" runat="server" DefaultMode="Insert" OnItemCommand="frmActivityStatus_ItemCommand">
            ...
            <InsertItemTemplate>
                ...
                <div class="container">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">Add Product Status</div>
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <asp:LinkButton ID="btnAdd" runat="server" CommandName="Add" Text="Add" CssClass="btn btn-primary btn-sm pull-right" ValidationGroup="vldgrpStatus" CausesValidation="true" />
                                        </div>
                                    </div>
                                    <br />
                                </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <asp:LinkButton ID="btnUpdateDescription" runat="server" CommandName="Save" Text="Update" CssClass="btn btn-primary btn-sm pull-right" ValidationGroup="vldgrpStatus" />
                                        </div>
                                    </div>
                                    <br />
                                </div>
        ...
        <div class="container">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <asp:GridView ID="grdStatusList" runat="server" DataKeyNames="Activity_Status_Id" AllowPaging="True" AutoGenerateColumns="False" CssClass="table table-hover table-striped" EmptyDataText="No Deactivations set" OnRowCommand="grdStatusList_RowCommand" OnRowDataBound="grdStatusList_RowDataBound">
