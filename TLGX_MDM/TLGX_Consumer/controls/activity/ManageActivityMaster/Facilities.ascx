<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Facilities.ascx.cs" Inherits="TLGX_Consumer.controls.activity.ManageActivityMaster.Facilities" %>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        <label class="control-label col-md-4" for="txtHotelName">
                                            Facility Category
            ...
            <div class="form-group">
                <div id="dvGrid" runat="server" class="control-label col-sm-12">
                    <asp:GridView ID="grdSearchResults" runat="server" AllowPaging="false" AllowCustomPaging="false" AutoGenerateColumns="False" DataKeyNames="Activity_Id" CssClass="table table-hover table-striped">
                        <Columns>
                            <asp:BoundField DataField="" HeaderText="Facility Category" />
                            <asp:BoundField DataField="" HeaderText="Facility Type" />
