<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="contacts.ascx.cs" Inherits="TLGX_Consumer.controls.activity.ManageActivityMaster.contacts" %>
...
<asp:UpdatePanel ID="updPanContacts" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        ...
        <asp:FormView ID="frmContactDetaiil" runat="server" DataKeyNames="Activity_Contact_Id" DefaultMode="Insert" OnItemCommand="frmContactDetaiil_ItemCommand" >
            ...
            <InsertItemTemplate>
                ...
                <div class="form-group row">
                    <div class="col-md-10">
                        <form id="uriForm" class="form-horizontal">
                            ...
                            <div class="form-group row" style="display: none;">
                                <label class="control-label col-sm-2" for="txtEmail">Activity ID</label>
                                <div class="col-sm-10">
                    ...
                    <div class="col-md-2">
                        <asp:LinkButton ID="btnAdd" runat="server" CommandName="AddContact" Text="Add" CssClass="btn btn-primary btn-sm" ValidationGroup="ActivityContacts" CausesValidation="true" />
                    </div>
                </div>
            ...
            <EditItemTemplate>
                ...
                <br />
                <asp:LinkButton ID="btnUpdate" runat="server" CommandName="UpdateContact" Text="Update" CssClass="btn btn-primary btn-sm" ValidationGroup="ActivityContacts" CausesValidation="true" />
        ...
        <asp:GridView ID="grdContactDetails" runat="server" AutoGenerateColumns="False" DataKeyNames="Activity_Contact_Id" CssClass="table table-hover table-striped" EmptyDataText="No Contact details" OnRowCommand="grdContactDetails_RowCommand" OnRowDataBound="grdContactDetails_RowDataBound" > 
            <Columns>
                ...
                <asp:TemplateField ShowHeader="false">
                    <ItemTemplate>
                        <asp:LinkButton ID="btnSelect" runat="server" CausesValidation="false" CommandName="Select" CssClass="btn btn-default"
                            Enabled='<%# Eval("IsActive") %>' CommandArgument='<%# Bind("Activity_Contact_Id") %>'>
                ...
                <asp:TemplateField ShowHeader="false">
                    <ItemTemplate>
                        <asp:LinkButton ID="btnDelete" runat="server" CausesValidation="false" CommandName='<%# Eval("IsActive").ToString() == "True" ? "SoftDelete" : "UnDelete"   %>'
                            CssClass="btn btn-default" CommandArgument='<%# Bind("Activity_Contact_Id") %>'>
